...
function RegisterPassword({ languageSelected, handleNextScreen, role, setPasswordMain }) {
    ...
    const handleCheckPasswordRegister = () => {
        if (password.length < 6) {
            ...
            if (role === 3) {
                ...
                navigate('/register-profile-partner', { state: { email: email, serviceCategoryId: serviceCategoryId, password: password } })
            }
        }
    }
